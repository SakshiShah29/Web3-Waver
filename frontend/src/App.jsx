"0x4dE10fbEADA0B8aCC49c9f647E7915fe06bf3b34";
...
export default function App() {
  ...
  */
  const contractAddress = "0x9436753011a15f04f1D9CE54C9136a07f820A687";
  ...
  let waveText;
    ...
    waveText = (<div>
      <div className="inputContainer">
        <textarea className="textarea" id="waveMessage" placeholder="Write me a message..." cols="60" rows="5"></textarea>
  ...
  return (
    <div className="mainContainer">
      ...
      <div className="dataContainer">
        ...
        <div className="bio">
         Hey I am Sakshi! Nice to meet you ! Let's connect to each other but before that connect your ethereum wallet  first :)
        </div>
